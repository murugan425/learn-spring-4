...
public class AppMain {
	...
	public static void main(String[] args) {
		...
		Person personObj1 = (Person) context.getBean("personBeanCreatedByFactoryMtd");
		Person personObj2 = (Person) context.getBean("personBean2");
		
		//Lets create the Person objects using Factory Method & Factory Beans.
